...
</html>`,document.getElementById("myElement").innerHTML=c,new $().print(document.getElementById("myElement")),i(d)}).catch(d=>{o(d)})})}static nota(t){return console.log("factura",t),new Promise((i,o)=>{const e=x.conversorNumerosALetras,s=new e().convertToText(parseInt(t.total)),a={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},l=P().env;N.toDataURL(`Fecha: ${t.fecha_emision} Monto: ${parseFloat(t.total).toFixed(2)}`,a).then(d=>{let c=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
...
</html>`,document.getElementById("myElement").innerHTML=c,new $().print(document.getElementById("myElement")),i(d)}).catch(d=>{o(d)})})}static notaCompra(t){return console.log("factura",t),new Promise((i,o)=>{const e=x.conversorNumerosALetras,s=new e().convertToText(parseInt(t.total)),a={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},l=P().env;N.toDataURL(`Fecha: ${t.fecha_emision} Monto: ${parseFloat(t.total).toFixed(2)}`,a).then(async d=>{let c=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
...
<table>
...
</html>`,document.getElementById("myElement").innerHTML=E,new $().print(document.getElementById("myElement")),s(p)}).catch(p=>{a(p)})})}static reciboCompra(t){return new Promise((i,o)=>{const e=x.conversorNumerosALetras,s=new e().convertToText(parseInt(t.total)),a={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},l=P().env;N.toDataURL(`Fecha: ${t.date} Monto: ${parseFloat(t.total).toFixed(2)}`,a).then(d=>{let c=`${this.head()}
    <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
    <img src="logo.png" alt="logo" style="width: 100px; height: 100px; display: block; margin-left: auto; margin-right: auto;">
    ...
    </html>`,document.getElementById("myElement").innerHTML=c,new $().print(document.getElementById("myElement")),i(d)}).catch(d=>{o(d)})})}static reciboTranferencia(t,i,o,e){return console.log("producto",t,"de",i,"ha",o,"cantidad",e),new Promise((n,s)=>{const a=x.conversorNumerosALetras,d=new a().convertToText(parseInt(e)),c={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},y=P().env;N.toDataURL(`de: ${i} A: ${o}`,c).then(u=>{let h=`${this.head()}
    <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
    <img src="logo.png" alt="logo" style="width: 100px; height: 100px; display: block; margin-left: auto; margin-right: auto;">
    ...
    <div style="padding: 0.0cm 0.3cm 0.0cm 0.3cm;  font-family:Verdana, sans-serif; position:relative; margin-top:0">
       ${o=="INGRESO"&&parseInt(t.name)>0?'<div class="numero" style="">'+t.name+"</div>":""}
       ${o=="INGRESO"&&parseInt(t.name)>0?"":'<div class="textocab" style="">'+t.name+"</div>"}
