...
<table>
    ...
    </html>`,document.getElementById("myElement").innerHTML=h,new $().print(document.getElementById("myElement")),n(u)}).catch(u=>{s(u)})})}static recibo(t){var d,c;let i="";const o=t.type;let e="",n=0,s="";o=="INGRESO"?(t.comment==null&&(t.comment=""),s="<table class='tab2'><tr><th>CANT</th><th>DETALLE</th><th>P/U</th><th>TOTAL</th></tr>",t.details.forEach(y=>{y.price==0?e+="<tr><td></td><td>"+y.product+"</td><td></td><td></td></tr>":e+="<tr><td>"+y.quantity+"</td><td>"+y.product+"</td><td>"+y.price+"</td><td>"+y.subtotal+"</td></tr>",n+=parseFloat(y.subtotal)}),s+=e,s+="<tr><td></td><td></td><td><b>TOTAL:</b></td><th>"+n.toFixed(2)+`</th></tr>
      <tr><td></td><td></td><td><b>Pago:</b></td><th>${t.pago}</th></tr>
      </table>`):(s="<table class='tab2'><tr><th>DESCRIPCION</th><th>PROVEEDOR</th><th>TOTAL</th></tr>",e+="<tr><td>"+t.descripcion+"</td><td>"+((d=t.client)==null?void 0:d.name)+"</td><td>"+t.total+"</td></tr>",s+=e,s+="<tr><td></td><td><b>TOTAL:</b></td><th>"+t.total+"</th></tr></table>");let a="";t.mesa!="MESA"&&(a="font-size:25px; font-weight:bold;font-style: italic;"),i=`<style>
    .imagen{
      width:60%
    }
    .titulo1 {
    ...
    <div style="padding: 0.0cm 0.3cm 0.0cm 0.3cm;  font-family:Verdana, sans-serif; position:relative; margin-top:0">
       ${o=="INGRESO"?'<div class="numero" style=""><span class="textocab">'+t.numero+"-</span>"+t.llamada+"</div>":""}
